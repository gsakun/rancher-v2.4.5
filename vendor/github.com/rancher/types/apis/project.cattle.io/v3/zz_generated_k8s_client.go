...
type Client struct {
	...
	applicationControllers                   map[string]ApplicationController
}
...
func (c *Client) Applications(namespace string) ApplicationInterface {
	objectClient := objectclient.NewObjectClient(namespace, c.restClient, &ApplicationResource, ApplicationGroupVersionKind, applicationFactory{})
